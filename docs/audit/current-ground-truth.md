...
**Task-first public discovery (2026-09-20):** [`session-knowledge-2026-09-20-task-first-public-site.md`](session-knowledge-2026-09-20-task-first-public-site.md) — Start / Create / Learn / session-aware Officer Hub, shared catalog and canonical route migration, explicit deliverables/privacy disclosures, local-only guided paths, and bookmarkable bilingual local search. Remaining validation: content-owner review of rough time estimates, in-context French copy review, assistive-technology testing, and moderated task research without analytics.

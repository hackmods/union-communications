...
**President soft launch (2026-08-19):** [`session-knowledge-2026-08-19-president-soft-launch.md`](session-knowledge-2026-08-19-president-soft-launch.md) — operator invites a president by local number; they set up Hall and invite officers/members while Hub stays unadvertised. `create_local` / `create_union` persist to Postgres when `DATABASE_URL` is set.

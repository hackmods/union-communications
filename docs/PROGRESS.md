...
## 2026-09-20 — Members Portal authorization and Portal persistence

- [x] Added normalized local membership, officer assignment, delegation, grievance participant/privacy/member-update/attachment-share, break-glass, and Portal schemas in forward-only migrations `0041`–`0052`; `0051` binds committee members to active same-local accounts and `0052` blocks archived Circle access.
- [x] Added shared actor/capability resolution, fail-closed RLS context, scoped organization APIs/UI, grievance access enforcement, member-safe Portal case DTOs, exact-resource break-glass, and hybrid-import protections.
- [x] Updated grievance API tests for hidden resource IDs and case relationship/privacy behavior; added hybrid import protection coverage; filtered calendar meetings through grievance authorization.
- [x] Updated RBAC/compliance/Local Portal documentation and recorded implementation status in [`members-portal-authorization-review-and-remediation-2026-09-20.md`](audit/members-portal-authorization-review-and-remediation-2026-09-20.md).
- [x] Captured session lessons in [`session-knowledge-2026-09-20-members-portal-authorization.md`](audit/session-knowledge-2026-09-20-members-portal-authorization.md) and phased remaining work in [`plan-members-portal-authorization-remaining-2026-09-20.md`](audit/plan-members-portal-authorization-remaining-2026-09-20.md).
- [x] Closed missing-local list/detail widening across core local features, Hub bylaws/proposals, and grievance-support CA snippets; added a shared unmatched-local filter and preserved only feature-defined owner/assignee relationships. Snippet direct-ID reads and writes now enforce local membership.

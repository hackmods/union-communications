...
7. [`docs/audit/current-ground-truth.md`](docs/audit/current-ground-truth.md) - **post-audit as-built** (prefer over stale `active-context.md`); session lessons: [`docs/audit/session-knowledge-2026-07-24.md`](docs/audit/session-knowledge-2026-07-24.md); external link audit: [`docs/audit/external-links-audit-plan.md`](docs/audit/external-links-audit-plan.md) (`LINK-001`)

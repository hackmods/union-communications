...
7c. **Task-first public discovery:** [`session-knowledge-2026-09-20-task-first-public-site.md`](docs/audit/session-knowledge-2026-09-20-task-first-public-site.md) — public catalog, canonical routes, shipped UX, and prioritized follow-up gaps. Read before changing Start/Create/Learn/Search discovery, catalog metadata, or public route migration.

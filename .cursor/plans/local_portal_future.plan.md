...
**Shipped MVP:** ADR-017, `/portal` Circles through P4 experience (One fight, Sidebars, Hold the line, search, @mentions, soft-delete, CSV import, activity pack, DnD Many hands, per-tool mute). Smoke: `e2e/portal.smoke.spec.ts`.
...
Circle templates, Many hands DnD, per-tool mute, Together digests, keyboard shortcuts, officer handoff activity pack, guest banner — done in memory.

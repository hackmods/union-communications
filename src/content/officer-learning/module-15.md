# Module 15: Duty of Fair Representation
...
⚠️ Warning: Telling a member "I'm not a lawyer, so I can't help" is **not** a DFR defence. The remedy is to investigate, document, communicate, and **escalate to servicing or counsel** — not to walk away. Ghosting a member after they ask for help is how locals lose DFR complaints.
...
5.  **Written recommendation** — even a short internal note: facts, analysis, proposed action, who reviewed.
...
⚠️ Warning: Promising "we'll take this to arbitration and win" without executive or counsel approval sets up a bad-faith claim when the file is later declined. The remedy: promise **process** ("I will investigate and bring a recommendation by [date]"), not outcomes.
...
⚠️ Warning: Ignoring a member's file because they complained about **you** personally is a classic bad-faith fact pattern. The remedy: hand the file to another steward or servicing **before** any decline — and document the conflict transfer.
...
Practice: **Round 1 — Intake to investigation.** Partner plays an angry member with a vague "harassment" complaint against a shift lead. You have 10 minutes to complete intake log fields, six W's headers, and one sentence on the next communication to the member.
...
- [ ] File protective grievance or seek extension when clocks are at risk — escalate if unsure
- [ ] Communicate receipt and next-step timeline to the member in writing
- [ ] Send **written decline** with reasons and constitution review path when not filing
- [ ] Avoid outcome promises — commit to process and dates
- [ ] Transfer file to another steward when personal conflict exists — document the handoff
- [ ] Escalate to servicing/counsel for safety reprisal, human rights, termination, or DFR threats
- [ ] Preserve investigation notes, emails, and comparator cases in the union file
- [ ] Flag parallel statutory routes (Code, OHSA, WSIB) even when grievance path closes
- [ ] Do not quote universal OLRB filing windows — refer process questions to counsel
- [ ] Brief the executive when a DFR-sensitive file closes — pattern risks are local, not solo

---

## Common pitfalls

1. **Ghosting** — Member hears nothing for weeks; Board application follows.
2. **Verbal declines** — "We decided not to grieve" without written reasons or review path.
3. **Clock amnesia** — Strong facts, missed Step 1; DFR and merits both lost.
4. **Friend favouritism** — Fast-track for allies, slow-walk for critics; discrimination exposure.
5. **Victory promises** — Creates bad-faith claim when executive later settles or declines.
6. **Solo law practice** — Complex discipline or Code overlap handled without servicing.
7. **Conflict blindness** — Steward who is the subject of the complaint still controls the file.
8. **Investigation after decision** — Notes written to justify a conclusion already shared verbally.
...
### Question 1
What is the union's core obligation under Ontario's duty of fair representation (DFR)?
*   A) Win every grievance filed by members in the bargaining unit.
*   B) Represent members in good faith, without arbitrary, discriminatory, or bad-faith refusal to process legitimate grievances.
*   C) File every workplace complaint regardless of contractual merit.
*   D) Provide free personal legal advice to members on any employment issue.

**Correct Answer: B**
*Explanation*: DFR is a **process** duty tied to exclusive bargaining-agent status — fair investigation, non-discriminatory treatment, and good-faith decisions — not a guarantee of outcomes.
...
### Question 5
A member's Step 1 grievance deadline is in two days. The assigned steward is unsure whether the case has merit. Best first move?
*   A) Do nothing until the executive meets next month.
*   B) Tell the member DFR prevents any filing.
*   C) Assess clocks immediately, escalate to servicing/counsel if needed, and consider a protective filing with open-door language while investigation continues.
*   D) Promise the member a full arbitration win to buy time.

**Correct Answer: C**
*Explanation*: Clock discipline is core to DFR. Protective filings and timely escalation beat silent delay; merit debates can continue while deadlines are preserved.

# Module 6: Dismantling Systemic Barriers & Building Collective Power
...
*   **Systemic Barriers**: Policies, procedures, or informal practices that appear neutral on their face but have a disproportionately negative impact on marginalized groups.
    *   *Example in the Workplace*: Requiring a Canadian driver's license for an office-based job where driving is not a core requirement.
    *   *Example in the Union*: Holding all steward meetings on Friday evenings, which systematically excludes workers with religious observances or family care obligations.
...
⚠️ Warning: Voluntary surveys must be truly voluntary. Never pressure members to disclose identity data in open floor meetings.
...
1.  **Name the barrier** — e.g., "62% of temp workers reporting no transit access to GMM site."
2.  **Pair the clause** — e.g., hybrid meeting option, cultural leave swap, microaggression investigation timeline.
3.  **Attach accountability** — joint committee review, reporting deadlines, or ADR opt-in before Step 2.
...
*   **Smudge Ceremony Logistics**: To host a traditional smudge ceremony safely and inclusively during a union meeting:
    *   Provide **24-to-48-hour advanced notice** to the venue management and the membership.
    *   Post clear signage at meeting entrance doors.
    *   Honor the rule of **voluntary participation** (members who do not wish to participate can step out without judgment).
    *   Establish alternative ventilation or separate rooms to accommodate members with severe asthma or chemical sensitivities to smoke.
...
⚠️ Warning: Anti-racism preamble language without enforcement mechanism is symbolic. Attach timelines, joint committee review, or dispute resolution to preamble commitments so they breathe in practice.
...
- [ ] Distinguish individual incident from systemic pattern before choosing grievance vs. bargaining fix
- [ ] Bargaining survey: voluntary, anonymous demographic and barrier questions
- [ ] Cost-share funding for precarious members on bargaining team
- [ ] Propose preamble, microaggression process, chosen family, cultural leave swaps as package
- [ ] ADR clause: voluntary, confidential where appropriate, grievance rights preserved
- [ ] Elder invitation: tobacco tie protocol, left hand, organic tobacco in cloth
- [ ] Smudge: 24–48 hr notice, signage, voluntary participation, smoke alternatives
- [ ] Review local meeting times/locations for union-side systemic barriers
- [ ] Convert survey patterns into three-part proposals: barrier + clause + accountability
- [ ] Share aggregate survey results with membership before bargaining opens
- [ ] Active harassment/microaggression: grieve now; bargain enforcement language for next round
- [ ] Package equity clauses with economic items — avoid standalone preamble-only asks
- [ ] Cross-check microaggression timelines against **CUPE Stop Harassment guide** benchmarks
- [ ] Confirm ADR opt-out preserves grievance deadlines before member agrees to circle

---

## Common pitfalls

1. **Individual-only responses** — Disciplining one supervisor while keeping the driver's-license requirement.
2. **Surveillance demographics** — Mandatory identity disclosure or public "who is racialized" lists.
3. **Token bargaining seats** — Diverse photo without cost-share or alternate voice for precarious workers.
4. **ADR as trap** — "Voluntary" ADR that blocks formal grievance timelines without clear opt-out.
5. **Ceremony without protocol** — Inviting Elders without tobacco offering or smudge logistics harms relationships.

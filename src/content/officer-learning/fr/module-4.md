# Module 4 : Gouvernance démocratique de la section locale, rencontres et élections au scrutin secret
...
## 1. Rôles des dirigeants locaux et partage de la charge
Une section locale saine exige une division claire du travail parmi le conseil exécutif local élu. Surmener un seul dirigeant mène à l'épuisement et à l'échec administratif.

*   **Président** : Sert de chef de la direction. Préside toutes les rencontres exécutives et d'assemblée générale, signe les documents officiels, représente la section locale publiquement, et supervise la coordination générale des comités et délégués de la section locale.
*   **Vice-président** : Travaille étroitement avec le président pour partager la charge administrative. Exerce les devoirs du président en son absence et supervise souvent des portefeuilles précis (comme la santé et la sécurité, l'éducation ou la mobilisation).
*   **Secrétaire** : Le gardien officiel des dossiers. Responsable d'émettre les avis de rencontre, de tenir des procès-verbaux exacts, de maintenir les listes de membres, et de traiter la correspondance officielle.
*   **Trésorier** : Le gardien financier de la section locale. Maintient tous les grands livres financiers, traite les paiements approuvés, assure la conformité à la double signature, et prépare les états financiers et budgets mensuels et annuels.

Les ateliers de leadership local de la **Fédération du travail de l'Ontario** et du **CTC** insistent sur le partage des portefeuilles : lorsqu'un dirigeant détient chaque fonction administrative, les rencontres glissent, les délais de grief souffrent, et les membres perçoivent l'exécutif comme fermé. Le module 5 couvre les spécificités du trésorier ; ce module se concentre sur les mécanismes du secrétaire et du président de séance.

🪞 Réflexion : Si votre secrétaire dirige aussi chaque comité, le suivi du quorum peut échouer — c'est un risque de gouvernance, pas un échec personnel.
...
## 3. Rédaction des procès-verbaux : le principe de l'« écriture sobre »
Les procès-verbaux du secrétaire sont le dossier juridique de la section locale. Une erreur courante est de rédiger les procès-verbaux comme une transcription dramatique, en enregistrant opinions personnelles, arguments et débats émotionnels.

### La norme de l'« écriture sobre »
Les procès-verbaux doivent être objectifs, concis et axés sur les **décisions et actions, pas les discussions**.
*   **À consigner** :
    *   La date, l'heure et le lieu de la rencontre.
    *   Les noms des dirigeants présents, et si le quorum a été établi.
    *   Le libellé exact de chaque motion, les noms du proposeur et du secondeur, et si la motion a été adoptée ou rejetée.
    *   Les tâches précises assignées aux individus et les échéances convenues.
*   **À ne pas consigner** :
    *   Qui était en colère ou quels adjectifs ils ont utilisés.
    *   Des résumés de débats personnels ou d'échanges argumentatifs.
    *   Des transcriptions d'opinions ou de griefs personnels partagés durant le plancher ouvert.

💡 Note : Les procès-verbaux sobres protègent les membres. Une transcription verbatim d'une dispute peut être utilisée contre quelqu'un des années plus tard ; le résultat d'une motion avec des tâches assignées fait avancer la section locale.
...
3.  **Trois appels** : Le président de séance doit appeler d'autres candidatures trois fois avant de déclarer les mises en candidature closes.
4.  **Se présenter ou décliner** : Le secrétaire lit la liste des candidats dans l'**ordre inverse de mise en candidature**. Les candidats doivent indiquer s'ils « se présentent » (acceptent) ou « déclinent » la candidature.
...
💡 Note : Un quorum perdu à une AGM n'autorise pas l'exécutif à dépenser sans un nouveau vote — replanifiez ou utilisez la méthode de scrutin alternative autorisée.

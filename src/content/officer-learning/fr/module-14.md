# Module 14 : Valeur syndicale quotidienne : orientation, affinité et communauté
...
*   **Ressentir/Comprendre** : Accueillant et solidaire envers les travailleurs tout nouveaux ; fier de la valeur non-crise que le syndicat offre hors des griefs.
*   **Être capable de** : Animer une orientation efficace de 15 minutes pour nouveaux membres ; distribuer des cartes de rabais syndicales sans partager de listes ; organiser des coalitions de solidarité communautaire qui renforcent la préparation à la grève.

---

## 1. L'orientation de 15 minutes pour nouveaux membres le jour 1
Si le premier contact syndical d'un travailleur est une rencontre disciplinaire ou un vote de grève, il verra le syndicat comme une gestion de crise lointaine. **L'accueil du jour 1** donne le ton : solidaire, pratique et fier.

### Négocier le bloc de temps
Poussez pour une clause de convention accordant au syndicat **15 à 30 minutes** pendant l'intégration officielle de l'employeur — payé, espace privé, sans gestionnaire présent. Sans la clause, les délégués accueillent quand même les nouveaux à la pause et planifient une rencontre dans la première semaine.

### La trousse d'accueil (dossier physique ou numérique)
...
💡 Note : Une carte signée le jour 1 bat la poursuite du même travailleur pendant trois ans lors d'un vote de ratification.

---

## 2. Avantages d'affinité sans partager les listes
Les programmes d'affinité négocient des **rabais exclusifs** — équipement de travail, détail, assurance auto — en utilisant le pouvoir d'achat collectif. Ils bâtissent la loyauté quotidienne quand les membres sentent le syndicat dans leur portefeuille, pas seulement à la table de négociation.

### Le modèle de distribution sécurisé

| Étape | À faire | À ne pas faire |
| --- | --- | --- |
| Vérifier l'admissibilité | Émettre une **carte de rabais à l'effigie du syndicat** ou un code à usage unique présenté à la caisse | Envoyer au fournisseur un CSV de noms et courriels personnels |
| Promouvoir l'avantage | Paragraphe au bulletin, trousse d'orientation, affiche à la salle à manger | Laisser le fournisseur harceler les membres directement |
...
⚠️ Avertissement : Si un fournisseur exige votre liste d'adhésion pour « activer » le rabais, la réponse est non — offrez des cartes, pas des données.

📝 Exercice : Rédigez une clause d'accord fournisseur d'un paragraphe : « La section ne transférera pas les renseignements personnels des membres ; l'admissibilité est vérifiée par présentation de la carte de rabais syndicale officielle. »

---

## 3. Syndicalisme communautaire et construction de coalitions
Les luttes en milieu de travail n'existent pas dans le vide. Le **syndicalisme communautaire** relie les objectifs de négociation à la santé de la communauté environnante — ainsi, quand les lignes de piquetage se lèvent, les voisins savent déjà pourquoi.

### Luttes partagées (exemples dans les secteurs ontariens)
*   **Personnel hospitalier :** Les ratios de dotation sont les temps d'attente des patients — s'allier aux coalitions de défense des patients et de la santé.
*   **Personnel de soutien scolaire :** La sécurité en classe est la sécurité des enfants — s'allier aux conseils de parents et aux coalitions éducatives.
*   **Travailleurs municipaux :** Les services publics sont le tissu social — coordonner avec usagers du transport et syndicats de locataires.

### Tactiques de coalition qui fonctionnent
1.  **Se montrer d'abord :** Parrainer des collectes alimentaires, nettoyages de parcs, sports jeunesse — logo visible, sans contrepartie d'endossement.
2.  **Presse conjointe :** Les partenaires communautaires amplifient les demandes de négociation qui profitent au public, pas seulement à la table.
3.  **Banque de solidarité de grève :** Les relations bâties à la banque alimentaire se paient sur la ligne de piquetage.
4.  **Limites claires :** Soutenir les campagnes communautaires sans remettre les listes de membres aux ONG partenaires — même règle que pour les fournisseurs.

La **FTO** et les conseils du travail locaux convoquent des coalitions ; l'éducation du **CTC** sur le syndicalisme communautaire cadre le jeu long.

🪞 Réflexion : Nommez un bien public que votre dernière demande de négociation a protégé — un partenaire communautaire aurait-il pu le dire avec vous au micro ?

---

## 4. En quoi ceci diffère du module 6 (Bâtir le pouvoir collectif)
Le module 6 et le module 14 renforcent tous deux la solidarité — ce ne sont pas les mêmes cours.

| Sujet | Module 6 — Bâtir le pouvoir collectif | Module 14 — Valeur syndicale quotidienne |
| --- | --- | --- |
| Focus | Barrières d'équité, RDA, clauses d'équité en négociation | Accueil jour 1, avantages d'affinité, coalitions communautaires |
| Outils principaux | Voies des droits de la personne, accommodation, langage de CC | Trousses d'accueil, cartes de rabais, partenariats publics |
| Confidentialité des listes | Protège les membres marginalisés dans les plaintes | Protège **tous** les membres du partage avec fournisseurs/politique |
| Horizon temporel | Correctifs structurels sur les cycles de négociation | Impression du premier quart + avantages visibles toute l'année |
| Mesure du succès | Gains d'équité exécutoires dans la CC | Cartes signées, adoption des rabais, alliés de coalition à la ligne |

Les délégués ont besoin des deux : le module 6 enlève les barrières ; le module 14 fait sentir que le syndicat vaut la peine d'adhérer dès la première heure.

💡 Note : Les coalitions communautaires ne remplacent pas les clauses d'équité — elles amplifient les histoires que le module 6 gagne à la table.
...
**Deuxième temps — ratification six mois plus tard.** Deux des trois ont signé le jour 1 ; un non. Un vote de convention est prévu.

**À appliquer :** Les deux sont admissibles ; cibler le troisième avec une rencontre d'adhésion rapide — même trousse, cinq minutes, sans honte. La carte d'affinité fonctionne encore pour tous les cotisants ; le droit de vote exige la carte.

**À ne pas appliquer :** Ne pas supposer que la déduction de cotisations équivaut à un vote. Ne pas donner au fournisseur le courriel du troisième travailleur « pour qu'il se sente inclus ».

---

## Exercice pratique

Exercice : **Tour 1 — Script d'orientation.** Chronométrez-vous en livrant le script en quatre temps à un collègue en quinze minutes. Vérification : Avez-vous mentionné le délégué avant la clause d'arbitrage ?

**Tour 2 — Limite fournisseur.** Jeu de rôle du trésorier refusant une demande de liste. Offrir des cartes, une clause écrite de non-partage, et une affiche à l'effigie du syndicat pour la vitrine du magasin.

**Tour 3 — Carte de coalition.** Choisissez une demande locale et nommez deux groupes communautaires qui bénéficieraient de la gagner. Rédigez trois arguments qu'ils pourraient répéter publiquement.

🪞 Réflexion : Qu'a fait votre syndicat pour vous avant que vous ayez besoin d'un grief ?
...
- [ ] Obtenir des accords fournisseurs écrits avec clause de non-partage de listes
- [ ] Promouvoir les avantages d'affinité à l'orientation pour montrer la valeur quotidienne
- [ ] S'allier à des groupes communautaires sur les thèmes de négociation au bien public
- [ ] Se montrer au travail de coalition avant d'avoir besoin de solidarité sur la ligne de piquetage
- [ ] Ne pas remettre les listes de membres aux ONG communautaires — les inviter aux événements publics
- [ ] Distinguer la culture d'accueil (module 14) du travail d'équité/RDA (module 6)
- [ ] Suivre les cartes distribuées — pas l'accès des fournisseurs à votre base de données
- [ ] Briefer l'exécutif : le succès d'affinité ne l'emporte jamais sur la confidentialité des listes

---

## Pièges courants

1. **Introduction d'abord en crise** — Les travailleurs rencontrent le syndicat seulement lors d'une discipline ou d'un vote de grève.
2. **Cours de grief le jour 1** — Submerger les nouveaux qui ont encore besoin d'un plan de la salle à manger.
3. **Liste contre rabais** — Échanger les données des membres contre un pourcentage de détail.
4. **Pourriel du fournisseur** — Laisser les partenaires envoyer des courriels aux membres parce que « c'est une bonne affaire ».
5. **Coalition de façade** — Logo sur un dépliant sans se montrer pour les luttes des partenaires.
6. **Confusion des modules** — Enseigner les cadres d'équité RDA quand les délégués n'ont pas encore de trousse d'accueil.
...
*   A) Négocier une clause de convention qui augmente l'allocation de téléphone cellulaire du président de la section.
*   B) S'allier à des groupes de parents locaux et à des coalitions communautaires pour campagner en faveur d'un financement public accru du personnel scolaire, montrant comment la sécurité en classe protège à la fois les travailleurs et les enfants.
*   C) Tenir toutes les réunions du conseil d'administration local dans des restaurants privés haut de gamme du centre-ville.

# Module 9 : Représenter les membres dans les réclamations d'avantages, de pensions et d'invalidité
...
⚠️ Avertissement : Ne coachez jamais un membre à cacher des restrictions qui touchent la sécurité — la confidentialité n'est pas la dissimulation des limites de travail. Partagez les fonctions ; retenez le diagnostic.
...
Exercice : **Tour 1 — Script de confidentialité.** Jouez le rôle des RH exigeant une liste de médicaments. Le délégué répond avec la limite aptitudes-fonctionnelles-seulement et une offre écrite de restrictions mises à jour.
...
- [ ] Séparer le diagnostic des aptitudes fonctionnelles dans chaque demande des RH
- [ ] Coacher les membres : partager les restrictions ; retenir les dossiers cliniques
- [ ] Inscrire au calendrier les échéances d'appel d'assureur le jour où un refus arrive
- [ ] Utiliser le CCA (ou équivalent) pour auditer les refus et le retard du transporteur
- [ ] Pousser les RH à presser l'assureur quand le texte du régime appuie la réclamation
- [ ] Traiter les demandes d'EME comme exceptionnelles — vérifier le langage de la CC et la suffisance médicale
...
- [ ] Briefer les membres que les étiquettes PGA « de soutien » peuvent encore être discriminatoires

---

## Pièges courants

1. **Conformité pacifique** — Remettre des dossiers complets pour « accélérer » le RTW.
2. **Finalité de l'assureur** — Traiter le premier refus comme la fin de la défense.
3. **Normalisation des EME** — Accepter les médecins de l'employeur comme gardiens de routine.
4. **Mythe de la règle neutre** — Croire que le calcul égal de PGA guérit les devoirs des droits de la personne.
5. **Confusion de modules** — Arguer seulement EPJ quand le combat vivant est le retard de réclamations et la confidentialité.
...
*   A) Remplacer le médecin traitant du membre par un médecin de l'employeur.
*   B) Revoir les refus contestés, auditer la performance de l'assureur et presser les processus RH/transporteur dans les règles du régime.
*   C) Divulguer publiquement le diagnostic du membre à l'unité de négociation.

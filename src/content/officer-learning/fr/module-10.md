# Module 10 : Coordonner les comités locaux et conjoints en milieu de travail
...
*   **Ressentir/Comprendre** : Que les comités conjoints sont de puissants caucus stratégiques pour bâtir la force de négociation collective, plutôt que des bureaux de discussion administratifs menés par la direction.
*   **Être capable de** : Orienter les enjeux des membres vers le forum le plus efficace (CSTS, CPS ou grief) ; préparer des dossiers d'information pour comités conjoints ; faire respecter les refus de travail fondés sur la sécurité.

---

## 1. CSTS vs CPS : pouvoirs et limites
Ne traitez pas chaque rencontre conjointe comme la même rencontre.

| Dimension | CSTS | CPS |
| --- | --- | --- |
| Source juridique | Législation sur la sécurité au travail (concepts de la **LSST** en Ontario) | Convention collective / pratique — généralement consultatif |
| Focus central | Dangers, violence, qualité de l'air, ergonomie, blessures critiques | Charge de travail, horaires, politique opérationnelle, friction contractuelle |
| Inspection / enquête | Rôles statutaires d'inspection et d'enquête sur blessures critiques | Pas de pouvoir d'inspection statutaire automatique |
...
## 2. Discipline de caucus uni
Avant toute rencontre conjointe, les représentants syndicaux tiennent une **préréunion privée (caucus)** :

*   Aligner sur les faits, demandes et lignes de sortie.
*   Assigner les rôles de parole (lead, preuves, preneur de notes).
*   Décider quels points escaladent en grief si l'employeur stalle.
*   Résoudre les désaccords internes **avant** que la direction n'entre dans la salle.
...
## 3. Escalade multi-comités
Les enjeux sérieux tiennent rarement dans une seule porte. Exemple : le sous-effectif qui cause des blessures et des violations de convention.

L'escalade efficace court **en parallèle** :

1.  **CSTS** — inspection de danger, recommandations, horloge de réponse écrite de l'employeur.
2.  **CPS** — charge de travail, politique d'horaire, correctifs opérationnels au dossier.
3.  **Grief / grief de groupe** — clauses de dotation, santé et sécurité ou charge de travail de la CC.
4.  **Dossier de négociation** — preuves de schéma pour le prochain tour.

Les dossiers d'information devraient voyager avec l'enjeu : chronologie, photos, rapports d'incident, procès-verbaux antérieurs et la demande précise pour chaque forum. Les cours de santé et sécurité du **CTC** insistent sur les pistes documentaires — le « on va regarder » verbal meurt au prochain changement de quart.

📝 Exercice : Prenez un enjeu vivant du plancher et rédigez un plan d'orientation en trois lignes : demande CSTS / demande CPS / théorie de grief.
...
*   Le membre rapporte le danger et refuse le travail non sécuritaire de bonne foi.
*   Le superviseur enquête ; la représentation syndicale du CSTS est engagée comme requis.
*   Si non résolu, escaladez par la voie de refus de la LSST (y compris l'implication du ministère lorsque déclenchée).
*   En parallèle : mettez le danger à l'ordre du jour formel du CSTS pour que recommandations et réponses écrites suivent même après la fin du refus immédiat.

N'échangez pas un refus contre une « discussion au CPS le mois prochain » pendant que le danger demeure vivant.

💡 Note : Un refus de travail protège le moment ; les recommandations du CSTS protègent le système. Utilisez les deux.

---

## Scénario commenté

**La ligne sous-effectifée.** Un département manque de personnel chaque après-midi. Les entorses montent ; les membres rapportent de se précipiter sur des gardes non sécuritaires. Un délégué veut seulement un grief. Un autre veut seulement une discussion au CPS. Un troisième argumente avec le premier devant les RH sur si un garde est « vraiment nécessaire ».

**À appliquer :** Appelez un caucus — faites respecter la discipline de caucus uni (section 2). Orientez blessures/gardes vers inspection et recommandations du CSTS ; mettez charge de travail/horaire au CPS ; déposez un grief de groupe sur les clauses contractuelles et liées à la sécurité (section 3). Présentez un ensemble uni de demandes dans chaque salle.

**À ne pas appliquer :** N'aérez pas le débat sur le garde devant la direction. Ne laissez pas le danger coincé au CPS seul. N'attendez pas l'arbitrage avant d'utiliser le pouvoir statutaire de recommandation du CSTS.
...
Exercice : **Tour 1 — Caucus.** Deux délégués sont en désaccord sur si le sous-effectif est « sécurité » ou « opérations ». Menez un caucus de cinq minutes pour produire une position unie et des assignations de rôles avant un CSTS simulé.

**Tour 2 — Matrice d'orientation.** Pour stress thermique + heures supplémentaires forcées, remplissez : produits CSTS, produits CPS, produits de grief, liste de preuves. Débriefing : Quelqu'un a-t-il brisé la discipline de caucus dans la rencontre conjointe simulée ?

🪞 Réflexion : Nommez un enjeu que votre section locale continue de déverser dans le mauvais comité — et la porte qu'elle devrait aussi ouvrir.

---

## Liste de contrôle du plancher

- [ ] Savoir quels enjeux sont CSTS (dangers) vs CPS (ops/charge) vs les deux
- [ ] Tenir un caucus syndical avant chaque rencontre conjointe
- [ ] Assigner orateur lead, lead preuves et preneur de notes en caucus
- [ ] Résoudre les désaccords internes en privé — discipline de caucus uni
- [ ] Apporter des dossiers d'information : chronologie, incidents, procès-verbaux antérieurs, demandes claires
- [ ] Utiliser le pouvoir de recommandation du CSTS pour démarrer l'horloge de réponse écrite de l'employeur
...
1. **Mauvaise porte seulement** — Dangers coincés au CPS ; charge coincée seulement au CSTS.
2. **Caucus brisé** — Représentants syndicaux argumentant devant la direction.
3. **Procès-verbal comme thérapie** — Parler sans demandes, échéances ou recommandations écrites.
4. **Report de refus** — Envoyer un travail non sécuritaire à un futur ordre du jour au lieu du processus de la LSST.
5. **Foi mono-voie** — Attendre un seul grief pendant que le pouvoir statutaire du CSTS reste inutilisé.
...
*   A) Le CPS peut émettre des ordres de style LSST avec force ministérielle par défaut.
*   B) Le CPS remplace le besoin de griefs chaque fois que des procès-verbaux existent.
*   C) Le CPS est typiquement consultatif sur les opérations et la charge de travail — utile pour la pression et la construction de dossier, mais sans le pouvoir statutaire de recommandation-réponse du CSTS.

# Module 7 : Le délégué comme mobilisateur et partenaire de négociation
...
⚠️ Avertissement : Transmettez toujours les questions juridiques aux représentants de service ou au conseiller juridique avant d'annoncer un *work-to-rule*. Les slogans du plancher ne réécrivent pas le LRT.
...
Exercice : **Tour 1 — Carte et mandat.** Esquissez une carte d'une page du milieu de travail (quarts × classifications × temp/perm). Encerclez deux poches non engagées et nommez un leader organique chacune. Rédigez trois questions de sondage d'élaboration des demandes qui convertissent les constats de la carte en langage de négociation.
...
- [ ] Savoir dans quelle phase vous êtes : Application, Élaboration des demandes ou Négociation
- [ ] Construire ou mettre à jour une carte du milieu de travail : quarts, classifications, statut, langues
- [ ] Identifier les leaders organiques dans les poches non engagées — pas seulement les délégués titrés
- [ ] Croiser la carte avec les lacunes d'adhésion
- [ ] Planifier des événements de solidarité avant les tactiques à plus haut risque
- [ ] Utiliser l'application rigide sur les clauses d'heures/HS/procédure ignorées
- [ ] Concevoir des mini-campagnes avec des demandes étroites et gagnables d'installations ou de sécurité
- [ ] Définir le *work-to-rule* comme devoirs à la lettre de la CC à rythme normal + refus des extras volontaires
- [ ] Ne jamais présenter les ralentissements concertés ou interdictions d'HS en cours de convention comme « *work-to-rule* »
- [ ] Faire autoriser les campagnes de *work-to-rule* / d'HS par le service ou le juridique avant le lancement
...
1. **Mobilisation quart de jour seulement** — Journées de chandails qui n'atteignent jamais les nuits ou les grappes temporaires.
2. **Carte comme ragot** — Listes d'identité ou dénonciations démographiques publiques.
3. **Sauter des échelons** — Passer aux interdictions d'HS avant que solidarité et application bâtissent la confiance.
4. **Étiquetage de ralentissement** — Appeler un rythme réduit du travail requis « *work-to-rule* ».
5. **Juridique maison** — Lancer une action en cours de convention sans autorisation service/juridique.
...
### Question 1
Durant un tour de négociation tendu, un superviseur demande à un délégué d'accomplir une tâche volontaire hors service. Le délégué refuse poliment et encourage d'autres membres à faire de même. Est-ce une action de « *Work-to-Rule* » juridiquement protégée ?
*   A) Non, tout refus coordonné de tâches est considéré comme une grève illégale.
*   B) Oui, parce que la tâche est volontaire et hors de la convention collective, les membres ont le droit de refuser.
*   C) Oui, mais seulement si le syndicat a déjà tenu un vote de grève formel.
...
*   A) Refus coordonné d'heures supplémentaires obligatoires et contractuellement requises lorsque la convention permet à l'employeur de les assigner.
*   B) Membres portant des chandails syndicaux identiques un jour désigné de solidarité.
*   C) Délégués refusant d'assister à des comités sociaux volontaires et non payés organisés par la direction.

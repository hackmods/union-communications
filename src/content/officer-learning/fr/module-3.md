# Module 3 : Droits de la personne, devoir d'accommodement et retour au travail inclusif (RAT)
...
1.  **Lien rationnel** : L'employeur a-t-il adopté la norme dans un but rationnellement lié à l'exécution de l'emploi ?
2.  **Bonne foi** : L'employeur a-t-il adopté la norme dans la croyance honnête et de bonne foi qu'elle était nécessaire pour atteindre ce but légitime lié au travail ?
3.  **Nécessité raisonnable** : La norme est-elle raisonnablement nécessaire pour accomplir ce but ? Pour le prouver, l'employeur doit démontrer qu'il est **impossible d'accommoder** les employés individuels partageant les caractéristiques du demandeur sans subir une **contrainte excessive**.
...
1.  **Coût quantifiable** : Le coût de l'accommodement doit être si substantiel qu'il altérerait la nature même de l'entreprise ou menacerait sa survie financière. (Les dépenses petites et routinières ne qualifient pas).
2.  **Sources de financement externes** : Toutes les subventions gouvernementales, programmes d'assurance ou fonds externes ont-ils d'abord été explorés ?
3.  **Risques pour la santé et la sécurité** : L'accommodement poserait-il un risque de sécurité immédiat, objectif et substantiel pour le travailleur accommodé, ses collègues ou le public, qui ne peut pas être atténué ?
...
⚠️ Avertissement : N'acceptez pas « on n'a rien essayé » comme contrainte. Demandez quels accommodements ont été considérés, chiffrés et rejetés — et pourquoi.
...
⚠️ Avertissement : La « coopération » ne signifie pas que le membre doit accepter la première offre de l'employeur. La participation de bonne foi inclut de proposer des alternatives et de rejeter des options qui rétrogradent ou isolent le travailleur.
...
- [ ] Confirmer le motif protégé et l'impact défavorable (règle, horaire, refus d'équipement)
- [ ] Parcourir les étapes Meiorin — identifier où la preuve de l'employeur est mince
- [ ] Exiger des preuves de contrainte : coûts, recherche de financement, analyse de sécurité objective
- [ ] Séparer les restrictions fonctionnelles du diagnostic dans tous les documents
- [ ] Bloquer les demandes de dossiers cliniques bruts, notes psychiatriques ou questions « pourquoi »
- [ ] Rédiger ou réviser un RAT progressif avec dates, heures, tâches et points de révision
- [ ] Préserver le statut dans l'unité de négociation et le taux de salaire dans la conception de l'accommodement
- [ ] Documenter les retards de l'employeur — les échéanciers d'accommodement comptent juridiquement
- [ ] Assister aux rencontres d'accommodement avec le membre — pas d'entrevues médicales en solo
- [ ] Noter les dates : demande reçue, réponse de l'employeur, rencontre de suivi planifiée
- [ ] Lorsque l'employeur cite le moral ou la préférence de la clientèle, nommez la **CODP** — contrainte invalide
- [ ] Si le harcèlement chevauche le handicap, ouvrir une voie parallèle selon le guide **Arrêter le harcèlement** du SCFP
- [ ] Avant d'accepter des tâches modifiées, confirmer qu'elles sont temporaires, significatives et dans l'unité
- [ ] Préparer un brouillon de grief si le dialogue stagne — le retard d'accommodement n'est pas neutre

---

## Pièges courants

1. **Divulgation du diagnostic** — Les membres en disent trop ; les gestionnaires pêchent ; les délégués doivent filtrer l'information.
2. **Panique face au silence de la convention** — La primauté des droits de la personne est la réponse, pas « on ne peut pas aider ».
3. **Accepter une contrainte invalide** — Le moral et la préférence de la clientèle reviennent parce que les délégués ne les contestent pas nommément.
4. **Emplois allégés permanents** — Une modification temporaire ne devrait pas devenir une rétrogradation indéfinie sans entente.
5. **Angle mort du harcèlement** — Les moqueries liées au handicap sont du harcèlement en droits de la personne ; croisez les schémas du guide **Arrêter le harcèlement** du SCFP.
...
*   A) Accepter — la convention l'emporte toujours.
*   B) La primauté des droits de la personne exige que l'employeur cherche un accommodement qui peut ajuster l'horaire ; le conflit contractuel seul n'est pas une contrainte excessive.
*   C) Dire au membre de porter grief sur l'ancienneté plutôt que sur l'accommodement.

...
*   **Know**: The constitutional and administrative boundaries of the Local Officers; the mathematical triggers for quorum based on local membership size.
*   **Feel/Understand**: Committed to maintaining open, highly accessible, and democratic local systems; valuing objective, decision-focused "dull writing" minutes over verbatim notes.
*   **Be Able To**: Calculate and monitor local quorum in real time; manage transition to "non-voting business" if quorum is lost; and run a multi-round secret ballot election calculating 50%+1 clear majorities.

---

## 1. Local Officer Roles & Workload Sharing
A healthy local union requires clear divisions of labor among the elected Local Executive Board. Overloading a single officer leads to burnout and administrative failure.

*   **President**: Serves as the Chief Executive Officer. Presides over all executive and general membership meetings, signs official documents, represents the local publicly, and oversees the general coordination of the local's committees and stewards.
*   **Vice-President**: Works closely with the President to share the administrative workload. Performs the President's duties in their absence and often oversees specific portfolios (such as health and safety, education, or mobilizing).
...
**Quorum** is the minimum number of signed-up members in good standing who must be present in a meeting to legally transact union business, pass motions, and conduct votes.

### The Universal Quorum Scale
To ensure democratic accountability across different local sizes, quorum is calculated on a tiered mathematical scale:
*   **Locals of 1 to 20 members**: Quorum is **50 percent** of the signed-up membership.
*   **Locals of 21 to 200 members**: Quorum is exactly **10 members**.
*   **Locals of 201 or more members**: Quorum is **5 percent** of the signed-up membership.

### Operating in a "Lost Quorum" State
...
## 3. Minute-Writing: The Principle of "Dull Writing"
The Secretary's minutes are the legal record of the local. A common mistake is writing minutes like a drama transcript, recording personal opinions, arguments, and emotional debates.

### The "Dull Writing" Standard
Minutes must be objective, concise, and focused on **decisions and actions, not discussions**.
*   **Do Record**:
    *   The date, time, and location of the meeting.
    *   The names of officers present, and whether quorum was established.
    *   The exact wording of every motion, the names of the mover and seconder, and whether the motion was carried or defeated.
    *   The specific tasks assigned to individuals and the agreed deadlines.
*   **Do NOT Record**:
    *   Who was angry or what adjectives they used.
...
3.  **Three Calls**: The Chair must call for further nominations three times before declaring nominations closed.
4.  **Stand or Decline**: The Secretary reads the list of nominees in **reverse order of nomination**. Candidates must state whether they "stand" (accept) or "decline" the nomination.
...
### Question 1
A local has 300 signed-up members. According to the Universal Quorum Scale, how many members must be present at a General Membership Meeting to legally vote on a motion to amend the local's bylaws?
*   A) 10 members.
*   B) 15 members (5% of 300).
*   C) 150 members (50% of 300).
*   D) 50 members.
...
*   B) The vote is void because quorum was lost before the vote occurred. The local can only conduct non-voting business.
...
**Correct Answer: B**
*Explanation*: Quorum must be maintained throughout the meeting for voting to occur. Once attendance falls below the threshold, the meeting enters a non-voting state. Any vote taken without quorum is legally void.

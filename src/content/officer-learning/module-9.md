# Module 9: Representing Members in Benefits, Pensions & Disability Claims
...
⚠️ Warning: Never coach a member to hide restrictions that affect safety — privacy is not concealment of work limits. Share functions; withhold diagnosis.
...
Practice: **Round 1 — Privacy script.** Role-play HR demanding medications list. Steward responds with functional-abilities-only boundary and a written offer of updated restrictions.
...
- [ ] Separate diagnosis from functional abilities in every HR request
- [ ] Coach members: share restrictions; withhold clinical charts
- [ ] Calendar insurer appeal deadlines the day a denial arrives
- [ ] Use JIC (or equivalent) to audit denials and carrier delay
- [ ] Push HR to pressure the insurer when plan text supports the claim
- [ ] Treat IME demands as exceptional — check CA language and medical sufficiency
...
- [ ] Brief members that "supportive" AMP labels can still be discriminatory

---

## Common pitfalls

1. **Peacekeeping compliance** — Handing over full charts to "speed up" RTW.
2. **Insurer finality** — Treating first denial as the end of advocacy.
3. **IME normalization** — Accepting employer doctors as routine gatekeepers.
4. **Neutral-rule myth** — Believing equal AMP math cures human rights duties.
5. **Module mix-up** — Arguing only BFOR when the live fight is claims delay and privacy.
...
*   D) To waive all appeal deadlines in exchange for a meeting.

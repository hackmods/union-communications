# Module 3: Human Rights, The Duty to Accommodate & Inclusive Return-to-Work (RTW)
...
1.  **Rational Connection**: Did the employer adopt the standard for a purpose rationally connected to the performance of the job?
2.  **Good Faith**: Did the employer adopt the standard in an honest, good-faith belief that it was necessary to achieve that legitimate work-related purpose?
3.  **Reasonable Necessity**: Is the standard reasonably necessary to accomplish that purpose? To prove this, the employer must demonstrate that it is **impossible to accommodate** individual employees sharing the characteristics of the claimant without experiencing **Undue Hardship**.
...
1.  **Quantifiable Cost**: The cost of the accommodation must be so substantial that it would alter the very nature of the business or threaten its financial survival. (Small, routine expenditures do not qualify).
2.  **Outside Sources of Funding**: Have all government grants, insurance programs, or external funds been explored first?
3.  **Health and Safety Risks**: Would the accommodation pose an immediate, objective, and substantial safety risk to the accommodated worker, their colleagues, or the public that cannot be mitigated?
...
⚠️ Warning: Do not accept "we tried nothing" as hardship. Ask what accommodations were considered, costed, and rejected — and why.
...
⚠️ Warning: "Cooperation" does not mean the member must accept the employer's first offer. Good-faith participation includes proposing alternatives and rejecting options that demote or isolate the worker.
...
- [ ] Confirm protected ground and adverse impact (rule, schedule, equipment denial)
- [ ] Walk Meiorin steps — identify where employer proof is thin
- [ ] Demand hardship evidence: costs, funding search, objective safety analysis
- [ ] Separate functional restrictions from diagnosis in all documents
- [ ] Block requests for raw clinical files, psychiatric notes, or "why" questions
- [ ] Draft or review phased RTW with dates, hours, duties, and review points
- [ ] Preserve bargaining unit status and wage rate in accommodation design
- [ ] Document employer delays — accommodation timelines matter legally
- [ ] Attend accommodation meetings with the member — no solo medical interviews
- [ ] Log dates: request received, employer response, follow-up meeting scheduled
- [ ] When employer cites morale or customer preference, name **OHRC** — invalid hardship
- [ ] If harassment overlaps disability, open parallel track per **CUPE Stop Harassment guide**
- [ ] Before accepting modified duties, confirm they are temporary, meaningful, and in-unit
- [ ] Prepare grievance draft if dialogue stalls — accommodation delay is not neutral

---

## Common pitfalls

1. **Diagnosis disclosure** — Members overshare; managers fish; stewards must gate information.
2. **Contract silence panic** — Human rights primacy is the answer, not "we can't help."
3. **Accepting invalid hardship** — Morale and customer preference recur because stewards do not challenge them by name.
4. **Permanent lite jobs** — Temporary modification should not become indefinite demotion without agreement.
5. **Harassment blind spot** — Disability-related mockery is human rights harassment; cross-check **CUPE Stop Harassment guide** patterns.
...
### Question 4
An employer says accommodation is impossible because seniority rules in the collective agreement require the member to take an undesirable shift. Best response?
*   A) Agree — the contract always wins.
*   B) Human rights primacy requires the employer to seek accommodation that may adjust scheduling; contract conflict alone is not undue hardship.
*   C) Tell the member to grieve seniority instead of accommodation.
*   D) Drop accommodation and file for disability pension immediately.

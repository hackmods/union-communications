...
function seedThreads(): DiscussionThread[] {
  return [
    ...
    },
    {
      ...
      createdByName: "Local 7 Steward (PT)",
...
function seedPosts(): DiscussionPost[] {
  ...
  return [
    ...
    },
    {
      ...
      body: "Can we slot 10 minutes for duty-bank clarification? @Local 7 President — members have been asking at the board.",
      createdAt: oneDayAgo,
      updatedAt: oneDayAgo,
      mentionedUserIds: ["user-president-7"],
      reactions: [{ kind: "solidarity", userId: "user-president-7" }],
    },
    {
      id: "disc-post-003",
    ...
    },
    {
      ...
      unionId: "union-b7p",
      localId: "local-7",
      authorId: "user-steward-7-pt",
      authorName: "Local 7 Steward (PT)",

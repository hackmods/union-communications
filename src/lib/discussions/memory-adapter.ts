...
function seedThreads(): DiscussionThread[] {
  return [
    ...
    },
    {
      ...
      createdByName: "Local 777 Steward",
...
function seedPosts(): DiscussionPost[] {
  ...
  return [
    ...
    },
    {
      ...
      body: "Can we slot 10 minutes for duty-bank clarification? @Local 777 President — members have been asking at the board.",
      createdAt: oneDayAgo,
      updatedAt: oneDayAgo,
    ...
    },
    {
      ...
      authorName: "Local 777 Steward (PT)",

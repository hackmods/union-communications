...
export const RLS_TENANT_POLICIES: readonly RlsPolicyContract[] = [
  { table: "customization_assets", policy: "customization_assets_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_assets", policy: "customization_assets_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_audit", policy: "customization_audit_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_audit", policy: "customization_audit_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_delivery_fragments", policy: "customization_delivery_fragments_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_delivery_fragments", policy: "customization_delivery_fragments_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_drafts", policy: "customization_drafts_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_drafts", policy: "customization_drafts_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_heads", policy: "customization_heads_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_heads", policy: "customization_heads_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_maintenance_grants", policy: "customization_maintenance_grants_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_maintenance_grants", policy: "customization_maintenance_grants_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_operations", policy: "customization_operations_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_operations", policy: "customization_operations_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_policy", policy: "customization_policy_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_policy", policy: "customization_policy_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_preset_bindings", policy: "customization_preset_bindings_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_preset_bindings", policy: "customization_preset_bindings_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_public_projections", policy: "customization_public_projections_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_public_projections", policy: "customization_public_projections_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_releases", policy: "customization_releases_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_releases", policy: "customization_releases_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_resources", policy: "customization_resources_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_resources", policy: "customization_resources_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_revisions", policy: "customization_revisions_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_revisions", policy: "customization_revisions_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_section_controls", policy: "customization_section_controls_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_section_controls", policy: "customization_section_controls_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_scopes", policy: "customization_scopes_operator_read", migration: "0054_customization_foundation.sql" },
  { table: "customization_scopes", policy: "customization_scopes_operator_write", migration: "0054_customization_foundation.sql" },
  { table: "customization_delivery_fragments", policy: "customization_fragments_reader", migration: "0054_customization_foundation.sql" },
  { table: "customization_public_projections", policy: "customization_projections_reader", migration: "0054_customization_foundation.sql" },

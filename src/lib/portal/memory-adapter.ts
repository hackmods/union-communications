...
/** Deterministic Hall id for a local. Seeded Local 7 keeps `circle-hall-7`. */
...
const hall: Circle = {
  ...
  kind: "local_hall",
  name: "Local 7 Hall",
  description: "Default Hall for Local 7 members and officers.",
...
const bulletin: BulletinPost[] = [
  ...
  },
  {
    ...
    body: "Union side only. Local 404: parking-pass item after two UCC meetings, still no system answer. Local 1337: classification delay — confirm nobody has already filed a grievance. Local 7: PT additional-hours letter. Local 502: intake wording so campus issues stay at UCC first. Drafts stay here. Signed minutes stay on the union and employer postings.",
    pinned: true,
...
const actions: ActionItem[] = [
  {
    ...
    assigneeName: "Local 7 Steward (FT)",
...
const binder: BinderItem[] = [
  ...
  },
  {
    ...
    contentType: "note",
    createdById: "user-steward-7",
    createdByName: "Local 7 Steward (FT)",
  ...
  },
  {
    ...
    circleId: caucus.id,
    unionId: UNION,
    title: "Union-side draft — PT hours letter (Local 7)",
...
const momentum: MomentumItem[] = [
  {
    ...
    updatedByName: "Local 7 President",
  ...
  },
  {
    ...
    updatedByName: "Local 7 Steward (FT)",
...
const sidebarThreads: SidebarThread[] = [
  {
    ...
    participantNames: ["Local 7 President", "Local 7 Steward (FT)"],

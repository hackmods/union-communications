...
/** Deterministic Hall id for a local. Seeded Local 777 keeps `circle-hall-7`. */
...
const hall: Circle = {
  ...
  kind: "local_hall",
  name: "Local 777 Hall",
  description: "Default Hall for Local 777 members and officers.",
...
const hall145: Circle = {
  id: hallCircleId("local-404"),
  unionId: UNION,
  localId: "local-404",
  kind: "local_hall",
  name: "Local 404 Hall",
  description: "Default Hall for Local 404 members and officers.",
  visibility: "local_members",
  createdById: "user-joint-404",
  createdAt: "2026-07-01T12:00:00.000Z",
  updatedAt: "2026-07-01T12:00:00.000Z",
};

const hall415: Circle = {
  id: hallCircleId("local-502"),
  unionId: UNION,
  localId: "local-502",
  kind: "local_hall",
  name: "Local 502 Hall",
  description: "Default Hall for Local 502 members and officers.",
  visibility: "local_members",
  createdById: "user-president-502",
  createdAt: "2026-07-01T12:00:00.000Z",
  updatedAt: "2026-07-01T12:00:00.000Z",
};

const hall560: Circle = {
  id: hallCircleId("local-1337"),
  unionId: UNION,
  localId: "local-1337",
  kind: "local_hall",
  name: "Local 1337 Hall",
  description: "Default Hall for Local 1337 members and officers.",
  visibility: "local_members",
...
const memberships: CircleMembership[] = [
  ...
  },
  {
    ...
    userName: "Local 404 joint-committee lead",
    role: "admin",
    muted: false,
    mutedTools: [],
    starred: true,
...
const bulletin: BulletinPost[] = [
  ...
  },
  {
    ...
    circleId: jhsc.id,
    unionId: UNION,
    authorId: "user-steward-7",
    authorName: "Local 777 Steward (FT)",
  ...
  },
  {
    ...
    circleId: caucus.id,
    unionId: UNION,
    authorId: "user-joint-404",
    authorName: "Local 404 joint-committee lead",
    title: "Caucus agenda before the next joint table",
    body: "Union side only. Local 404: parking-pass item after two UCC meetings, still no system answer. Local 1337: classification delay — confirm nobody has already filed a grievance. Local 777: PT additional-hours letter. Local 502: intake wording so campus issues stay at UCC first. Drafts stay here. Signed minutes stay on the union and employer postings.",
    pinned: true,
...
const comments: BulletinComment[] = [
  ...
  },
  {
    id: "bc-caucus-1",
    postId: "bp-caucus-1",
    authorId: "user-president-1337",
    authorName: "Local 1337 President",
  ...
  },
  {
    id: "bc-caucus-3",
    postId: "bp-caucus-1",
    authorId: "user-president-502",
    authorName: "Local 502 President",
...
const actions: ActionItem[] = [
  {
    ...
    assigneeName: "Local 777 Steward (FT)",
  ...
  },
  {
    ...
    unionId: UNION,
    listName: "Referrals",
    title: "Draft the Local 404 parking-pass UCC brief",
    assigneeId: "user-joint-404",
    assigneeName: "Local 404 joint-committee lead",
  ...
  },
  {
    ...
    unionId: UNION,
    listName: "Referrals",
    title: "Confirm Local 1337 classification is not already a grievance",
    assigneeId: "user-president-1337",
    assigneeName: "Local 1337 President",
...
const binder: BinderItem[] = [
  ...
  },
  {
    ...
    contentType: "note",
    createdById: "user-steward-7",
    createdByName: "Local 777 Steward (FT)",
  ...
  },
  {
    ...
    circleId: caucus.id,
    unionId: UNION,
    title: "Union-side draft — PT hours letter (Local 777)",
  ...
  },
  {
    ...
    circleId: caucus.id,
    unionId: UNION,
    title: "UCC referral notes — parking pass (Local 404)",
    folder: "Caucus drafts",
    content:
    ...
    contentType: "note",
    createdById: "user-joint-404",
    createdByName: "Local 404 joint-committee lead",
...
const dispatch: DispatchItem[] = [
  ...
  },
  {
    ...
    kind: "assignment",
    title: "Action assigned: Draft the Local 404 parking-pass UCC brief",
    createdAt: daysFromNow(-2, 10),
  },
  {
    id: "di-caucus-2",
    ...
    circleName: "Provincial joint-committee caucus",
    kind: "assignment",
    title: "Action assigned: Confirm Local 1337 classification is not already a grievance",
    createdAt: daysFromNow(-2, 10),
  },
];
...
const momentum: MomentumItem[] = [
  {
    ...
    updatedByName: "Local 777 President",
  ...
  },
  {
    ...
    progress: 35,
    updatedById: "user-steward-7",
    updatedByName: "Local 777 Steward (FT)",
  ...
  },
  {
    ...
    progress: 40,
    updatedById: "user-joint-404",
    updatedByName: "Local 404 joint-committee lead",
...
const sidebarThreads: SidebarThread[] = [
  {
    id: "sb-1",
    unionId: UNION,
    participantIds: ["user-president-7", "user-steward-7"],
    participantNames: ["Local 777 President", "Local 777 Steward (FT)"],
    updatedAt: "2026-07-20T16:00:00.000Z",
  },
  {
    id: "sb-caucus-1",
    unionId: UNION,
    participantIds: ["user-joint-404", "user-president-7"],
    participantNames: [
      "Local 404 joint-committee lead",
      "Local 777 President",
    ],
    updatedAt: daysFromNow(-1, 14),
  },

...
describe("resolveMentions", () => {
  it("matches roster display names", () => {
    const hits = resolveMentions(
      "Ping @Local 777 Member please",
      [
        { userId: "u1", userName: "Local 777 Member" },
        { userId: "u2", userName: "Local 777 President" },
      ],
      "u2",
    );
    expect(hits).toEqual([{ userId: "u1", userName: "Local 777 Member" }]);
  });
});

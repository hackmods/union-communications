...
function seedTemplates(): SharedTemplate[] {
  return [
    {
      id: "tmpl-001",
      unionId: "union-opseu",
...
const templates: SharedTemplate[] = seedTemplates();
...
export function resetMarketplaceMemoryForTests(): void {
  templates.splice(0, templates.length, ...seedTemplates());
}

...
export const DEMO_USERS: DemoUser[] = [
  ...
  },
  {
    ...
    localId: "local-243",
    bargainingUnitId: "bu-243-ft",
    accessibleLocalIds: ["local-243", "local-145", "local-415", "local-560"],
  ...
  },
  {
    ...
    divisionId: "division-caat",
    localId: "local-145",
    bargainingUnitId: "bu-145-pt",
    accessibleLocalIds: ["local-145"],
    roles: ["local_president"],
    requiresMfa: true,
    totpSecret: "JBSWY3DPEHPK3PXP",
  },
  {
    ...
    divisionId: "division-caat",
    localId: "local-415",
    bargainingUnitId: "bu-415-ft",
    accessibleLocalIds: ["local-415"],
    roles: ["local_president"],
    requiresMfa: true,
    totpSecret: "JBSWY3DPEHPK3PXP",
  },
